  ...
  .catch(error => {
    logger.error('Error logging in to Discord:', error);
       ...
       client.on('ready', () => { 
         ...
         let activities = [
           `DM me to open a ticket!`, 
           'DM Me to Contact SUpport!', 
           'DM me for any inquiries!', 
           `CSRPC On Top`, 
           `California State RP Community`, 
           `game coming soon to ROBLOX!`, 
           `DM me to open a ticket!`, 
           'DM me to Contact SUpport!', 
           'DM me for any inquiries!'
         ];
         ...
         setInterval(() => {
           client.user.setActivity(`${activities[i++ % activities.length]}`, {
             type: "STREAMING",
             url: "https://CALIFORNIA-STATE-ROLE-PLAY-COMMUNITY.US.EU.ORG"
           });
         }, 8000);
       });